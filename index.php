...
if(defined('MOBILE') and !isset($custom_mobile_actions[$action]) and !in_array($action, array('', 'pmail', 'vtopic', 'vthread', 'goforum', 'userinfo', 'editmsg', 'editmsg2', 'delmsg', 'deltopic', 'tpl', 'locktopic', 'movetopic', 'movetopic2', 'advld', 'downloadfile', 'pthread', 'ptopic', 'register', 'registernew', 'authorize', 'prefs', 'editprefs'))) { header("Location: {$main_url}/{$startIndex}"); exit; }
