...
Latest File Update: 2010-May-19
*/
if (!defined('INCLUDED776')) die ('Fatal error.');

if(!isset($_GET['chstat']) or $user_id==0) die('Fatal error.'); else $topic_status=(int)$_GET['chstat'];
$errorMSG=$l_forbidden; $correctErr=$backErrorLink;
if($userUnlock==2 and $topic_status==0 and !($user_id==1 or $isMod==1)) $topic=-1;
