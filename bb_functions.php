...
Copyright (C) 2004-2011 Paul Puzyrev, Sergei Larionov. www.minibb.net
...
$from_email="From: {$from_email}{$eeol}Reply-To: {$from_email}{$eeol}Errors-To: {$errors_email}{$eeol}Return-Path: {$errors_email}{$eeol}MIME-Version: 1.0{$eeol}Content-Type: text/plain{$charset}{$eeol}User-Agent: miniBB";
...
if($currPageNum!=PAGE1_OFFSET+1) $full_url.='page='.$currPageNum;
return $full_url;
}
}
